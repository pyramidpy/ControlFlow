...
messages to the user and the message will be delivered async. 
This is how you tell the user things and ask questions. 
Do not mention your tasks or the workflow. 
The user can only see messages you send them via tool. They can
...
def user_input(message: str) -> str:
    """
    Send a message to a human user.
    """
